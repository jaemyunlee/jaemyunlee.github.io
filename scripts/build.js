...
const CURATED_HEADLINES = {
  ...
  'lesson-02-5': '"물놀이용 타이어 튜브" 영어로 정확한 명칭은?',
  'lesson-02-6': '"오후 내내 물놀이했어요" 오후 내내는 영어로?',
  'lesson-02-7': '"아침 집안일/허드렛일을 끝내다" 집안일은 영어로?',
  'lesson-02-8': '"정말 큰 기쁨이자 특별한 즐거움이에요" 영어로 뭐라고 할까요?',
  'lesson-02-9': '"그 개울 그 자체"를 강조할 때 쓰는 표현은?',
  'lesson-02-10': '"호수로 물이 흘러 들어가다" 원어민이 쓰는 동사는?',
  'lesson-02-11': '"호수에 물고기를 방류하다" 영어로 뭐라고 할까요?',
  'lesson-02-12': '"세월이 흐르면서, 수년에 걸쳐" 영어 표현은?',
  'lesson-02-13': '"내장재를 모조리 다 뜯어내다" 영어로 뭐라고 할까요?',
  'lesson-02-14': '"곰팡이가 피지 않도록" 곰팡이 핀 상태는 영어로?',
  'lesson-02-15': '"경사 없이 평평하게 집을 짓다" 수평인/평평한은 영어로?',
  'lesson-02-16': '"나이가 들어감에 따라" 점진적 변화를 나타내는 접속사는?',
  'lesson-02-17': '"산 위의 광산(채굴) 장비" 광업/채굴은 영어로?',
  'lesson-02-18': '"마음껏 누리고 즐길 수 있게 되었어요" ~할 수 있게 되다는?'
};
