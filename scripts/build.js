...
const CURATED_HEADLINES = {
  ...
  'lesson-04-19': '"콘서트 내내 줄곧"을 뜻하는 필수 전치사는?',
  'lesson-04-20': '"~인지 아닌지 궁금해하다" 일상 대화 핵심 패턴은?',
  'lesson-04-21': '"공연이나 행사의 마지막 끝 무렵에" 영어 표현은?',
  'lesson-05-1': '"머리가 멍해서 생각이 안 돌아가요" 영어로?',
  'lesson-05-2': '"대학 부전공으로 이수하다" 영어 단어는?',
  'lesson-05-3': '"~와는 전혀 관련이 없다" 필수 숙어 표현은?',
  'lesson-05-4': '"대학 프로그램에 입학/합격하다" 영어 구동사는?',
  'lesson-05-5': '"대학 공식 성적 증명서"를 영어로 뭐라고 부를까요?',
  'lesson-05-6': '"요구 조건/자격 요건에 부합하다" 영어 표현은?',
  'lesson-05-7': '"시험이 여러 과목을 다루다" 필수 동사는?',
  'lesson-05-8': '"선수 과목, 필수 선행 과목"을 뜻하는 단어는?',
  'lesson-05-9': '"학점이나 수업을 면제받다" 고급 영어 동사는?',
  'lesson-05-10': '"학점 요건을 대체하여 인정받다" 유용한 동사는?',
  'lesson-05-11': '"또한, 마찬가지로, 역시" 문장 끝에 쓰는 일상 표현은?',
  'lesson-05-12': '"시험 문제로 출제되다, 나오다" 핵심 구동사는?',
  'lesson-05-13': '"객관식 (선택형 문제)"을 영어로 뭐라고 할까요?',
  'lesson-05-14': '"내가 쓴 답이나 결정을 뒤늦게 의심하다" 필수 구어 표현은?',
  'lesson-05-15': '"나름 괜찮게, 꽤 준수하게 해내다" 뜻의 부사는?',
  'lesson-05-16': '"3점 만점 중에서, 셋 중에서" 영어로?',
  ...
  'lesson-06-5': '"먹기 싫은 고추를 한쪽으로 쓱 치워두다" 영어로?',
  'lesson-06-6': '"다른 사람들 앞에서 잘난 척/허세 부리다" 영어로는?',
  'lesson-06-7': '"그 사람과 함께 어울리는 시간을 좋아하다" 영어로?',
  'lesson-06-8': '"모두 술집으로 데려가 지다" 수동태 영어 표현은?',
  'lesson-06-9': '"그 여러 번의 만남 중 어느 한 번"을 회상할 때 쓰는 표현은?',
  'lesson-06-10': '"연애를 시작한 지 얼마 안 된 연애 초기" 영어로는?',
  'lesson-06-11': '"마티네즈에서 라피엣까지 줄곧 내내" 강조 표현은?',
  'lesson-06-12': '"차를 몰고 코너(모퉁이)를 돌다" 영어로 뭐라고 할까요?',
  'lesson-06-13': '"계절, 연중 어느 시기인지"를 뜻하는 표현은?',
  ...
  'lesson-06-19': '"~라는 사실이 참 놀라웠어요" 영어 패턴은?',
  ...
  'lesson-07-6': '"격주로, 2주에 한 번꼴로" 일상 회화 표현은?',
  'lesson-07-7': '"혹시라도 ~했던 적이 있었다면" 과거를 회상하는 패턴은?',
  'lesson-07-8': '"사람들이 빤히 쳐다보다, 시선 집중을 받다" 영어로는?',
  'lesson-07-9': '"적어도 두 번은 사줬어요" 적어도는 영어로?',
  'lesson-07-10': '"내가 그렇게 하도록 부추긴 것 같아요" 영어 동사는?',
  'lesson-07-11': '"그 맛과 기대에 전혀 미치지 못하다" 핵심 숙어는?',
  'lesson-07-12': '"동료의 소개로 식당을 처음 알게 되다" 수동 표현은?',
  'lesson-07-13': '"딱 잘라 말할 수는 없지만" 원어민 회화 패턴은?',
  'lesson-07-14': '"원래 나야 하는 바로 그 맛" 핵심 조동사 표현은?',
  'lesson-07-15': '"예전의 그 맛이 나지 않다" 맛을 비교할 때 쓰는 말은?',
  'lesson-07-16': '"엄밀히 따지면, 사실상" 자주 쓰는 원어민 부사는?',
  'lesson-07-17': '"그 맛을 바탕(기준)으로 삼다" 필수 구동사는?',
...
function build() {
  ...
  // 7. Auto-generate YouTube Description files for all lessons
  try {
    const { generateAllYouTubeDescriptions } = require('./generate_youtube_description.js');
    generateAllYouTubeDescriptions();
  } catch (err) {
    console.warn('⚠️ Could not generate YouTube descriptions:', err.message);
  }
