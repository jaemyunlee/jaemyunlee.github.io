...
CURATED_HEADLINES = {
    ...
    ('lesson-05', 14): ('"시험이나 평가를 꽤 잘 치르다"', '성적을 잘 내다를 뜻하는 표현은?'),
    ('lesson-05', 15): ('"내가 쓴 답이나 결정을 뒤늦게 의심하다"', '필수 구어 표현은?'),
    ('lesson-05', 16): ('"나름 괜찮게, 꽤 준수하게 해내다"', '알아두면 유용한 부사는?'),
    ('lesson-05', 17): ('"3점 만점 중에서, 셋 중에서"', '영어로 어떻게 말할까요?'),
    ('lesson-05', 18): ('"어떻게든 무언가를 생각해내다/지어내다"', '원어민 핵심 구동사는?'),
    ('lesson-05', 19): ('"새로운 사실에 눈을 뜨게 하다"', '생생한 영어 관용구는?'),
    ('lesson-05', 20): ('"심도 있고 깊이 있는 대답"', '깊이 있는을 뜻하는 형용사는?'),
    ('lesson-05', 21): ('"우연히 시작하다, 어쩌다 발을 들이다"', '원어민 일상 구동사는?')
}
