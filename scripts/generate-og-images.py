...
CURATED_HEADLINES = {
    ...
    ('lesson-06', 6): ('"먹기 싫은 고추를 한쪽으로 쓱 치워두다"', '영어로 어떻게 말할까요?'),
    ('lesson-06', 7): ('"다른 사람들 앞에서 잘난 척/허세 부리다"', '원어민 필수 구동사는?'),
    ('lesson-06', 8): ('"그 사람과 함께 어울리는 시간을 좋아하다"', '따뜻한 영어 표현은?'),
    ('lesson-06', 9): ('"모두 술집으로 데려가 지다"', '수동태 영어 표현은?'),
    ('lesson-06', 10): ('"그 여러 번의 만남 중 어느 한 번"', '회상할 때 쓰는 표현은?'),
    ('lesson-06', 11): ('"연애를 시작한 지 얼마 안 된 연애 초기"', '영어로 뭐라고 할까요?'),
    ('lesson-06', 12): ('"마티네즈에서 라피엣까지 줄곧 내내"', '먼 거리를 강조할 때는?'),
    ('lesson-06', 13): ('"차를 몰고 코너(모퉁이)를 돌다"', '영어로 뭐라고 할까요?'),
    ('lesson-06', 14): ('"계절, 연중 어느 시기인지"', '뜻을 나타내는 표현은?'),
    ...
    ('lesson-06', 20): ('"~라는 사실이 참 놀라웠어요"', '영어 문형 패턴은?'),
    ('lesson-06', 21): ('"평온함을 방해하다, 심기를 건드리다"', '자주 쓰이는 동사는?'),
    ('lesson-06', 22): ('"야생동물의 목격 사례, 출몰"', '뜻을 나타내는 명사는?'),
    ('lesson-06', 23): ('"동파 방지 모드로 꼭 설정해야 해"', '~해야 한다는 영어로?'),
    ('lesson-06', 24): ('"물건 정리하고 잠그는 법을 알아내다"', '핵심 구동사는?')
}
