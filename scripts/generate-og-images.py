...
CURATED_HEADLINES = {
    ...
    ('lesson-07', 5): ('"격주로, 2주에 한 번꼴로"', '일상 회화 필수 표현은?'),
    ('lesson-07', 6): ('"혹시라도 ~했던 적이 있었다면"', '과거를 회상하는 패턴은?'),
    ('lesson-07', 7): ('"사람들의 시선 집중을 받다"', '빤히 쳐다봄을 당하다는?'),
    ('lesson-07', 8): ('"적어도 두 번은 사줬어요"', '적어도는 영어로?'),
    ('lesson-07', 9): ('"내가 그렇게 부추긴 것 같아요"', '부추기다, 권장하다는?'),
    ('lesson-07', 10): ('"그 맛과 기대에 전혀 미치지 못하다"', '핵심 숙어 표현은?'),
    ('lesson-07', 11): ('"동료 소개로 식당을 알게 되다"', '소개받다를 뜻하는 표현은?'),
    ('lesson-07', 12): ('"딱 잘라 말할 수는 없지만"', '원어민들이 자주 쓰는 패턴은?'),
    ('lesson-07', 13): ('"원래 나야 하는 바로 그 맛"', '핵심 조동사 표현은?'),
    ('lesson-07', 14): ('"예전의 그 맛이 나지 않다"', '맛을 비교할 때 쓰는 말은?'),
    ('lesson-07', 15): ('"엄밀히 따지면, 사실상"', '자주 쓰는 원어민 부사는?'),
    ('lesson-07', 16): ('"그 맛을 바탕(기준)으로 삼다"', '원어민 필수 구동사는?'),
    ('lesson-07', 17): ('"맨 처음 것만큼 맛있지는 않다"', '동등 비교 표현은?'),
    ('lesson-07', 18): ('"결과가 어떻게 완성될지"', '결과가 되다를 뜻하는 구동사는?'),
    ('lesson-07', 19): ('"반면에 그것엔 느끼함이 없었죠"', '대조를 나타내는 접속사는?'),
    ('lesson-07', 20): ('"왠지 나한테 더 기름지게 느껴지다"', '비교급 표현은?'),
    ('lesson-07', 21): ('"김치찌개는 두 달 동안 쉬자"', '휴식기를 갖다는 영어로?')
}
